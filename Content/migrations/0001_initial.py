    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='photos/%Y/%m/%d/', verbose_name='')),
                ('title', models.CharField(max_length=255, verbose_name='заголовок')),
                ('description', models.TextField(blank=True, null=True, verbose_name='описание ')),
                ('chanel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Content.channel', verbose_name='канал')),
            ],
            options={
                'verbose_name': 'Видео',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ManyToManyField(to='Content.video')),
            ],
            options={
                'verbose_name': 'хэштег',
